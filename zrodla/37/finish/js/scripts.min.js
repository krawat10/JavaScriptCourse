...
!function(){function e(e,r){n.className=e,n.innerHTML=r}function r(n){n.preventDefault();var s=t.querySelectorAll("input, textarea"),o={};[].forEach.call(s,function(e){o[e.name]=e.value}),AJAX({type:t.getAttribute("method"),url:t.getAttribute("action"),data:o,success:function(n){var s=JSON.parse(n);console.log(s),Array.isArray(s)?e("error",s.join("<br>")):"error"in s?e("error",s.error):"success"in s&&(e("success",s.success),t.removeEventListener("submit",r,!1),t.querySelector("button").setAttribute("disabled","disabled"))}})}var t=document.querySelector("#form"),n=document.querySelector("#message");t.addEventListener("submit",r,!1)}();